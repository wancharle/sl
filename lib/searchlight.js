...
(function() {
  var BIBLIOTECA, CEMUNI, CT, Config, Controle, Dados, Popup, PopupMarcador, SENADO_FEDERAL, Searchlight, TabConfiguracoes, TabList, UFES, ViewExtra, attribution, referencia_atual, sl_referencias,
  ...
  Searchlight = (function() {
    ...
    Searchlight.prototype.create = function() {
      this.viewExtra = new ViewExtra(this.config);
      $("#" + this.config.container_id).html("<ul class='nav nav-tabs' role='tablist'> <li class='active'><a data-toggle='tab' href='#" + this.config.tab_id + "'>Mapa</a></li> <li><a data-toggle='tab' href='#tab-" + this.config.lista_id + "'>Lista</a></li> " + (this.viewExtra.renderLi()) + " <li><a data-toggle='tab' href='#tab-" + this.config.configuracoes_id + "'>Configurações</a></li> </ul> <div class='tab-content'> <div class='tab-pane active' id='" + this.config.tab_id + "'><div id='" + this.config.map_id + "' > </div> </div> <div class='tab-pane' id='tab-" + this.config.lista_id + "' ><div class='searchlight-tab' id='" + this.config.lista_id + "'> </div> </div>" + (this.viewExtra.renderPane()) + " <div class='tab-pane' id='tab-" + this.config.configuracoes_id + "' ><div class='searchlight-tab' id='" + this.config.configuracoes_id + "'> </div> </div> </div> ");
