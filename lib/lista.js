...
(function() {
  ...
  TabList = (function() {
    ...
    TabList.prototype.load = function() {
      var cat_name, cat_str, html, i, j, k, len, len1, obj, ref, ref1, self;
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        for (i = k = 0, len1 = ref1.length; k < len1; i = ++k) {
          ...
          html = html + "<tr><td><a href='javascript:void(0);' data-index='" + i + "' data-cat='" + cat_name + "' class='tablist-item'> " + cat_str + "</a></td><td>" + (obj.texto || obj.comentarios) + "</td></tr>";
        }
      }
      html = html + "</table>";
