...
(function() {
  var Dados, Popup, TabList, dataview;
  ...
  TabList = (function() {
    ...
    TabList.prototype.load = function() {
      ...
      for (j = 0, len = ref.length; j < len; j++) {
        ...
        for (i = k = 0, len1 = ref1.length; k < len1; i = ++k) {
          ...
          html = html + "<tr><td><a data-index='" + i + "' data-cat='" + cat_name + "' class='tablist-item'> " + cat_str + "</a></td><td>" + (obj.texto || obj.comentarios) + "</td><td>" + extra + "</td></tr>";
        }
      }
      html = html + "</table>";
    ...
    TabList.prototype.open = function(i, cat_name) {
      var cat, obj;
      cat = this.dados.getCatByName(cat_name);
      obj = cat[i];
      this.popup.show();
      this.popup.setTitle(obj.cat);
      this.popup.setBody(dataview.getTextoParaPopup(obj, obj.texto));
