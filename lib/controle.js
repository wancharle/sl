...
(function() {
  var ClusterCtr, Controle, PopupMarcador, SLControl, SLUndoRedoControl, controls,
  ...
  Controle = (function() {
    ...
    function Controle(sl) {
      ...
      this.markerOpen = bind(this.markerOpen, this);
      ...
      this.config.on('marcador:open', (function(_this) {
        return function(ev, evData) {
          return _this.markerOpen(ev, evData);
        };
      })(this));
      this.config.onChild('click', '.marker-ver-mais', (function(_this) {
        return function(ev) {
          return PopupMarcador.show(_this.ultimoMarcadorAberto);
        };
      })(this));
    ...
    Controle.prototype.mostrarIconesMarcVisiveis = function() {
      ...
      for (i = j = 0, len = ref.length; j < len; i = ++j) {
        ...
        results.push(m.slinfo.escondido = false);
      }
      return results;
    };
    ...
    Controle.prototype.esconderIconesMarcVisiveis = function() {
      ...
      for (i = j = 0, len = markers.length; j < len; i = ++j) {
        ...
        results.push(m.slinfo.escondido = true);
      }
      return results;
    };
    ...
    Controle.prototype.markerOpen = function(ev, evData) {
      var center, m;
      m = evData.marcador;
      this.ultimoMarcadorAberto = m;
      if (this.sl.config.esconder_icones && m.slinfo.escondido) {
